...
> For coverage samples and evaluations, reach out at <span class="accent">moe[at]moesfrontmatters.com</span>
...
<a href="https://www.youtube.com" class="film-card" target="_blank" rel="noopener">
  <img src="./site-assets/promnight_poster.png" alt="Prom Night poster">
  <div class="film-overlay">
    <h3>Prom Night (2017)</h3>
    <p><strong>Role:</strong> Producer, Production Manager</p>
    <p><strong>Runtime:</strong> 13m 56s</p>
    ...
    <p class="film-synopsis">On the night of their teenagers' prom, three overprotective fathers find a positive pregnancy test and go on a mission to find out which one of their teens is pregnant before the end of the night.</p>
  </div>
</a>

<a href="https://vimeo.com/1058828508" class="film-card" target="_blank" rel="noopener">
  <img src="./site-assets/gourmade-poster.png" alt="Gourmade poster">
  <div class="film-overlay">
    <h3>Gourmade (2024)</h3>
    <p><strong>Role:</strong> Co-Producer</p>
    <p><strong>Genre:</strong> Mock Commercial, Comedy</p>
    <p><strong>Dir:</strong> Sam MacAdam</p>
    <p><strong>Cast:</strong> Paloma Nuñez, Emma Hunter</p>
    <p class="film-synopsis">When a late-night emotional eater tries out the latest health craze, a revolutionary smart oven called 'Gourmade', she'll soon find out that delicious meals aren't the only things this AI oven is dishing out.</p>
  </div>
</a>

<a href="https://www.youtube.com/watch?v=6ZXmlmHNco0" class="film-card" target="_blank" rel="noopener">
  <img src="./site-assets/Desire_Shot_2.png" alt="Desire poster">
  <div class="film-overlay">
    <h3>Desire (2014)</h3>
    <p><strong>Role:</strong> Executive Producer</p>
    <p><strong>Runtime:</strong> 13m 53s</p>
...
<a href="#" class="film-card" target="_blank" rel="noopener">
  <img src="./site-assets/bark_poster_2.png" alt="Bark poster">
  <div class="film-overlay">
    <h3>Bark (2023)</h3>
    <p><strong>Role:</strong> Producer, Production Manager</p>
    <p><strong>Runtime:</strong> 13m 8s</p>
    <p><strong>Genre:</strong> Drama</p>
    <p><strong>Dir:</strong> Ganesh Thava</p>
    <p><strong>Cast:</strong> Aranan Sathian, Ganesh Thava</p>
    <p class="film-synopsis">A queer South Asian boy on the precipice of self-discovery wages a silent battle against the rigid expectations imposed upon him. In this fragile moment, he stands at the edge of taking a courageous leap toward his authentic self.</p>
  </div>
</a>

<a href="https://www.cnn.com" class="film-card" target="_blank" rel="noopener">
  <img src="./site-assets/harriet-poster.png" alt="The Horrible History of Harriet Jones poster">
  <div class="film-overlay">
    <h3>The Horrible History of Harriet Jones (2023)</h3>
    <p><strong>Role:</strong> Producer, Production Manager</p>
    <p><strong>Runtime:</strong> 7m 7s</p>
